...
class GraalVmProjectGenerationConfiguration {
	...
	GraalVmGradleBuildCustomizer graalVmGradleBuildCustomizer(ProjectDescription description) {
		return new GraalVmGradleBuildCustomizer(description.getPlatformVersion());
	}
